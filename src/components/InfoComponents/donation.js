          ...
          <div className="container pt-3 pb-3">
            <div className="">
              <div className="inpagecontent" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="1000">
                <h1 className='headclass'>Donations</h1>
                <div>
                  <p>
                    SHS is a non-profit voluntary organization. The building was
                    originally built in 1945 and used by various owners. In 1987
                    it was purchased by SHS, renovated, and financed partly by
                    individual donors and partly by a government grant. A large
                    number of individuals made their invaluable contribution in
                    the form of cash, kind, expertise, time and goodwill. Regular
                    expenses consist of hydro (electricity), gas, water,
                    telephone, property insurance charges, cleaning, consumables,
                    and maintenance. The routine operation and maintenance is
                    financed by membership subscriptions, Puja offerings at
                    various occasions, regular donations in cash & kind,
